...
/// <summary>
/// Sphere 51a extension for BaseJewel to enable double-click equip behavior.
/// </summary>
public partial class BaseJewel
{
    /// <summary>
    /// Handles double-click on jewelry items (rings, bracelets, necklaces, earrings).
