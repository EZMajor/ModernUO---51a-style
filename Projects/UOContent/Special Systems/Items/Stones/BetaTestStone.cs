...
public partial class BetaTestStone : Item
{
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        if (from.GetFlag(MobileBoolTable.BetaTester))
        {
...
public class BetaTestStoneGump : Gump
{
    ...
    {
        // Mark as beta tester
        from.SetFlag(MobileBoolTable.BetaTester, true);
        ...
        if (bankBox != null)
        {
            ...
            // Add potions (Note: Mana potions don't exist in classic UO/51a era)
            consumablesBag.AddItem(new GreaterHealPotion(100));
            consumablesBag.AddItem(new HealPotion(100));
            consumablesBag.AddItem(new TotalRefreshPotion(100));

            // Add scrolls
            consumablesBag.AddItem(new LightningScroll(100));
            consumablesBag.AddItem(new GreaterHealScroll(100));
            consumablesBag.AddItem(new FlamestrikeScroll(100));
            consumablesBag.AddItem(new MagicReflectScroll(100));
